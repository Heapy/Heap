package by.ibragimov.natrus.domain.config;
...
@EnableJpaRepositories(basePackages = "by.ibragimov.natrus.dao")
@ComponentScan(basePackages = "by.ibragimov.natrus.dao")
public class DaoConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("by.ibragimov.natrus.dao");
