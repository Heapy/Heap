...
public class ReceiptItemDto implements BaseDto, Identified<Long> {
    ...
    private ReceiptItemDto(Builder builder) {
        id = builder.id;
        price = builder.price;
    ...
    public static Builder newBuilder(ReceiptItemDto copy) {
    ...
    public static final class Builder {
        ...
        public ReceiptItemDto build() {
            return new ReceiptItemDto(this);
        }
    }
}
